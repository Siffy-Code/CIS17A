...
public:
    ...
    binXfer *Brd2Bin ();                              //Converts a boardset data into a binXfer binary receipt to write save files
    ...
    void Shoot (string ,string [][9],string [][9],short &,bool &);   //Checks a player's input to determine if their guess was a hit or miss
    ...
    string modR(bool b,int x,int y){BSAI test=BSAI(); return test.AIguess(b,x,y);}
