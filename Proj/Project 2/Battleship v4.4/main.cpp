...
//Needs turn-by-turn menu still and destroy functions implemented, as well constants.
//Check for values that are not being reset on validation loops
//v4.4
//AI has increased functionality to follow potential ship locations after a hit.  Does
//not function perfectly with boundaries, but will reset its own errors after a few
//attempts with a new random guess if it can't overcome the boundary.  This is derived
//from an abstract class for grading purposes.  It functions within a do-while loop with
//individual component validation.

//nOT ALL DATA IS BEING RESTORED BY LOADING THE GAME, SAVE FUNCTION IS TOO SMALL
