...
public:
    ...
    siffy(){cout<<"siffyconsttest0"<<endl;siffyI=0;cout<<"where"<<endl;siffyB=0;siffyC='0';siffyS = new string;*siffyS="0";cout<<"sifconsttest1"<<endl;}    //needs allocation of dynamic memory
    ...
    void flipB(){cout<<"flipB1"<<endl;if(siffyB==false){siffyB=true;}else{siffyB=false;}cout<<"flipB2"<<endl;}
