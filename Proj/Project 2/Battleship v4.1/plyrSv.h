...
private:                        //Necessary information to play a game of battleship
    ...
    shipDat P1Ships[5];           //Player 1 Ships and their locations
    shipDat P2Ships[5];           //Player 2 Ships and their locations
    short P1Pts,P2Pts;          //Player points
    short turn, ShpDZ, tMax;           //Current and maximum turns.  Cannot exceed 81 and loops if under 1 turn
